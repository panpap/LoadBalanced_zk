        ...
        throws KeeperException, IOException, RequestProcessorException
    {
        ...
        switch (type) {
            ...
            case OpCode.setData:
                ...
                LOG.info("panpap - setData : " +  setDataRequest.toString() + " Path: " + setDataRequest.getPath() + " Version: " + setDataRequest.getVersion()+" Data: "+setDataRequest.getData().toString()); 
    ...
    protected void pRequest(Request request) throws RequestProcessorException {
        ...
        try {
            ...
            case OpCode.setData:
                ...
                LOG.info("panpap - Request toString: "+request.type+" "+ request.toString());
